...
(function(a){function g(c,b,d){for(var e=0,l=d.length;e<l;e++)a.isFunction(d[e][c])&&d[e][c].call(d[e],b)}function f(c,b){g("preLayout",c,b);for(var d=0,a=b.length;d<a;d++){var e=b[d].layout.children;e&&e.length&&f(c,e)}g("postLayout",c,b)}function h(c,b){e.initialized=!0;g("updateLayout",c,b);for(var d=0,a=b.length;d<a;d++){var l=b[d].layout.children;l&&l.length&&h(c,l)}}function e(c,l){c={force:c};l=l?a(l):r;k&&(d.css("overflow-y",k),k=null);m&&(d.css("overflow-x",m),m=null);var g=b.innerWidth(),
p=b.innerHeight();f(c,l);var n=b.innerWidth(),q=b.innerHeight();if(g!=n||p!=q){f(c,l);var t=b.innerWidth(),v=b.innerHeight();if(n!=t||q!=v)g=function(){if(u||q!=v)m=d.css("overflow-x"),"hidden"!=m&&d.css("overflow-x","scroll");if(u||n!=t)k=d.css("overflow-y"),"hidden"!=k&&d.css("overflow-y","scroll")},e.initialized&&g(),f(c,l),e.initialized||g()}h(c,l)}for(var b=a(window),d=null,c=60,l,r=a(),p=a(),m,k,n=navigator.userAgent.toLowerCase(),q=/(chrome)[ \/]([\w.]+)/.exec(n)||/(webkit)[ \/]([\w.]+)/.exec(n)||
/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(n)||/(msie) ([\w.]+)/.exec(n)||0>n.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(n)||[],n=q[1]||"",q=q[2]||"0",t="msie"==!n||8!=parseInt(q,10),u="mozilla"==n,w=window.requestAnimationFrame,v=window.cancelAnimationFrame||window.cancelRequestAnimationFrame,z=["ms","moz","webkit","o"],y=0;y<z.length&&!w;++y)w=window[z[y]+"RequestAnimationFrame"],v=window[z[y]+"CancelAnimationFrame"]||window[z[y]+"CancelRequestAnimationFrame"];if(w)var x=function(c){return w(c)};
x||(x=window.setTimeout);v||(v=window.clearTimeout);var D=x,E=v;e.ua={browser:n,version:q};e.config=function(b,d){switch(b){case "fps":c=d;break;case "vsync":t=d;break;case "default":x=D;v=E;break;case "fallback":x=window.setTimeout,v=window.clearTimeout}A=t?function(){e()}:C};e.schedule=function(c,b){if(b||!l)l&&v(l),l=x(function(){e();l=null},c||0)};e.defer=function(b,d){"undefined"==typeof d&&(d=1E3/c);return x(b,d)};e.undefer=function(c){return v(c)};e.add=function(c){d||(d=a("BODY:first"));c.layout=
a.extend({children:[]},c.layout);c.layout&&c.layout.parent?(c.layout.parent.layout.children||(c.layout.parent.layout.children=[]),c.layout.parent.layout.children.push(c)):r=r.add(a(c));a.isFunction(c.startLayout)&&c.startLayout.call(c);c=a(c);0==p.length&&0<c.length&&a(window).bind("resize",A);p=p.add(c)};e.del=function(c){a.isFunction(c.stopLayout)&&c.stopLayout.call(c);c=a(c);p=p.not(c);r=r.not(c);0==p.length&&a(window).unbind("resize",A)};var B=!1,C=function(){if(B)return!1;B=x(function(){e();
B=!1},1E3/c)},A=t?function(){e()}:C;"undefined"==typeof OCBNET&&(window.OCBNET={});OCBNET.Layout=e})(jQuery);
(function(a){function g(e){var b,d,c=e.charAt(0).toUpperCase()+e.slice(1),l=["Moz","Webkit","O","ms"],f=document.createElement("div");if(e in f.style)d=e;else for(var h=0;h<l.length;h++)if(b=l[h]+c,b in f.style){d=b;break}return a.support[e]=d}if(!a.cssHooks)throw"jQuery 1.4.3+ is needed for this plugin to work";for(var f=["boxSizing","transform","perspective","transformStyle","backfaceVisibility"],h=f.length;h--;)(function(){var e=f[h],b=g(e);b&&b!==e&&(a.cssHooks[e]={get:function(d,c,e){return a.css(d,
b)},set:function(d,c){d.style[b]=c}})})()})(jQuery);
(function(){var a={add:function(a){var f=a.handler;a.handler=function(a){var e=f.call(this,a);if(0==e||a.isPropagationStopped()){var b=a.type,d=a.isTrigger,c=a.isPropagationStopped,l=a.isImmediatePropagationStopped;a.type="trap"+a.type;a.isPropagationStopped=function(){return!1};a.isImmediatePropagationStopped=function(){return!1};jQuery(a.currentTarget).parent().trigger(a);a.type=b;a.isTrigger=d;c&&a.stopPropagation();l&&a.stopImmediatePropagation();if("undefined"!=typeof e)return e}}}};"onmousedown"in
...
this.start.center.x,y:this.move.center.y-this.start.center.y};this.center=this.move.center;this.rotation=this.move.rotation-this.start.rotation;this.distance=this.move.distance-this.start.distance;var c=Math.abs(this.offset.x),m=Math.abs(this.offset.y);b={dx:f,dy:h,finger:e,gesture:this,originalEvent:b};a(this.el).triggerHandler(new a.Event("handmove",b));"undefined"==typeof this.swipeSector&&(this.config.decideOnFirst||Math.pow(this.config.swipeMinDistance,2)<c*c+m*m)&&(this.swipeSector=parseInt(180*
Math.atan2(m,c)/Math.PI/90*this.config.swipeSectors,10),this.swipeSector=Math.min(this.swipeSector,this.config.swipeSectors-1));"undefined"!=typeof this.swipeSector&&a(this.el).triggerHandler(new a.Event("handswipe",b));1<this.fingers&&a(this.el).triggerHandler(new a.Event("handtransform",b))}};b.fingerUp=function(b){var c=b.id;if(this.hasFinger(c)){var l=this.getFinger(c);l.x=b.x;l.y=b.y;var f=g[c].x-b.x;b=g[c].y-b.y;this.stop={center:this.getCenter(),rotation:this.getRotation(),distance:this.getDistance()};
this.offset={x:this.stop.center.x-this.start.center.x,y:this.stop.center.y-this.start.center.y};this.center=this.stop.center;this.rotation=this.stop.rotation-this.start.rotation;this.distance=this.stop.distance-this.start.distance;f=new a.Event("handstop",{dx:f,dy:b,finger:l,gesture:this});a(this.el).triggerHandler(f);this.fingers--;delete this.offset;delete this.rotation;delete this.distance;delete this.swipeSector;f.isDefaultPrevented()?(l=a.inArray(l.id,this.ordered),this.ordered.splice(l,1),delete this.finger[c]):
(this.finger={},this.fingers=0,this.ordered.length=0);l=a.inArray(this,e[c]);-1!=l&&e[c].splice(l,1);0==e[c].length&&(delete g[c],delete e[c])}};b.getCenter=function(){var b={x:0,y:0},c;for(c in this.finger){var a=this.finger[c];b.x+=a.x;b.y+=a.y}this.fingers&&(b.x/=this.fingers,b.y/=this.fingers);return b};b.getRotation=function(){if(2>this.fingers)return 0;for(var b=0,c=0,a=0,e=0,f=this.ordered.length;e<f;e++)for(var h=this.finger[this.ordered[e]],g=e+1;g<f;g++){a++;var n=this.finger[this.ordered[g]],
b=b+(n.x-h.x),c=c+(n.y-h.y)}return 180*Math.atan2(c/a,b/a)/Math.PI};b.getDistance=function(){if(2>this.fingers)return 0;for(var b=0,c=0,a=0,e=0,f=this.ordered.length;e<f;e++)for(var h=this.finger[this.ordered[e]],g=e+1;g<f;g++){a++;var n=this.finger[this.ordered[g]],b=b+Math.abs(n.x-h.x),c=c+Math.abs(n.y-h.y)}b/=a;c/=a;return Math.sqrt(b*b+c*c)};b.hasFinger=function(b){return b in this.finger};b.getFinger=function(b){return this.finger[b]}})(OCBNET.Gestures.prototype);a.fn.gesture=function(b){a(this).each(function(d,
...
(function(a){!("ontouchstart"in window)||window.PointerEvent||window.navigator.msPointerEnabled||window.navigator.msMaxTouchPoints||window.navigator.pointerEnabled||window.navigator.maxTouchPoints||(function(g){g.init.push(function(f){var h=this;a(f).bind("touchstart",function(e){var b=e.originalEvent.changedTouches||[],d=a(e.currentTarget).data("gesture");d!==h&&eval("alert('assertion')");a(b).each(function(b,l){b=new a.Event("fingerdown",{type:"touch",x:l.clientX||l.screenX,y:l.clientY||l.screenY,
id:l.identifier,originalEvent:e});d.fingerDown(b)});d.config.hatchTouchDown||e.preventDefault()});a(f).bind("handswipe",function(a){2==a.gesture.config.swipeSectors&&(0===a.gesture.swipeSector&&a.gesture.config.native.panY&&a.preventDefault(),1===a.gesture.swipeSector&&a.gesture.config.native.panX&&a.preventDefault())})})}(OCBNET.Gestures.prototype),a(document).bind("touchend touchcancel",function(g){a(g.originalEvent.changedTouches||[]).each(function(f,h){f=a.Event("fingerup",{type:"touch",x:h.clientX||
h.screenX,y:h.clientY||h.screenY,id:h.identifier,originalEvent:g});OCBNET.Gestures.fingerup(f)})}),a(document).bind("touchmove",function(g){a(g.originalEvent.changedTouches||[]).each(function(f,h){f=a.Event("fingermove",{type:"touch",x:h.clientX||h.screenX,y:h.clientY||h.screenY,id:h.identifier,originalEvent:g});OCBNET.Gestures.fingermove(f)})}))})(jQuery);
(function(a){function g(b){var c=b.originalEvent,e=a(b.currentTarget).data("gesture");e!==this&&eval("alert('assertion')");c=new a.Event("fingerdown",{type:"pointer",x:c.pageX,y:c.pageY,id:c.pointerId,originalEvent:b});e.fingerDown(c);e.config.hatchPointerDown||b.preventDefault()}function f(b){var c=b.originalEvent;b=a.Event("fingermove",{type:"pointer",x:c.pageX,y:c.pageY,id:c.pointerId,originalEvent:b});OCBNET.Gestures.fingermove(b)}function h(b){var c=b.originalEvent;b=new a.Event("fingerup",{type:"pointer",
x:c.pageX,y:c.pageY,id:c.pointerId,originalEvent:b});OCBNET.Gestures.fingerup(b)}if(window.PointerEvent||window.navigator.msPointerEnabled&&window.navigator.msMaxTouchPoints||window.navigator.pointerEnabled&&window.navigator.maxTouchPoints){var e={up:"MSPointerUp",move:"MSPointerMove",down:"MSPointerDown",cancel:"MSPointerCancel",action:"ms-touch-action"};(window.PointerEvent||window.navigator.pointerEnabled)&&window.navigator.maxTouchPoints&&(e={up:"pointerup",move:"pointermove",down:"pointerdown",
cancel:"pointercancel",action:"touch-action"});(function(b){b.init.push(function(b){var d=[],f=this.config.native||{};f.panY&&d.push("pan-y");f.panX&&d.push("pan-x");0==d.length&&d.push("none");f=a.proxy(g,this);a(b).bind(e.down,f).css(e.action,d.join(" "))})})(OCBNET.Gestures.prototype);var b=[e.up,e.cancel].join(" ");a(document).bind(b,h);a(document).bind(e.move,f)}})(jQuery);
...
b.trigger("config",h);a(["text","tmpl","klass","selector"]).each(function(){b[this]=d[this]});var c=b.tmpl,l=b.klass;isNaN(d.align)&&(d.align=.5);isNaN(d.panelsVisible)&&(d.panelsVisible=1);var r=b.container=a(g),p=b.slides=r.find(">."+l.panel);if(!(d.dontInitSingle&&2>p.length)){f=b.viewport=r.wrapAll(c.viewport).parent();c=b.wrapper=f.wrapAll(c.wrapper).parent();g=g.attributes;for(var m=g.length;m--;)f.attr(g[m].name,g[m].value),r.removeAttr(g[m].name);r.css({margin:"0",padding:"0"});c.addClass(l.wrapper);
f.addClass(l.viewport);r.addClass(l.container);b.smin=b.smax=0;d.vertical&&l.vertical&&b.wrapper.addClass(l.vertical);!d.vertical&&l.horizontal&&b.wrapper.addClass(l.horizontal);b.position=a.isFunction(d.slideFirst)?d.slideFirst.call(b):d.slideFirst||0;g=e("align",.5);e("alignPanelDim",g);e("alignPanelOpp",g);e("alignViewport",g);for(g=this.slides.length;g--;)c=a(this.slides[g]),"dim"==d.panelFixedAxis?c.outerWidth(c.width()):"opp"==d.panelFixedAxis&&c.outerHeight(c.height());b.cloned=a();if(d.carousel&&
p.length){g=d.cloneAfter;c=d.cloneBefore;m=d.clonePanels;m=!0===m?Math.ceil(d.panelsVisible):!1===m?0:parseInt(m+.5);g=!0===g?Math.ceil(m*(1-d.alignViewport)):!1===g?0:isNaN(g)?0:g;for(var c=!0===c?Math.ceil(m*(0+d.alignViewport)):!1===c?0:isNaN(c)?0:c,m=a([]),k=a([]);c>p.length;)c-=p.length,a.merge(k,p.clone());for(0<c&&(k=a.merge(p.slice(-c).clone(),k));g>p.length;)g-=p.length,a.merge(m,p.clone());0<g&&a.merge(m,p.slice(0,g).clone());m.appendTo(b.container).addClass("cloned");k.prependTo(b.container).addClass("cloned");
b.smax+=m.length;b.smax+=k.length;b.smin+=k.length;a.merge(b.cloned,k);a.merge(b.cloned,m);b.before=k;b.after=m}b.trigger("init");b.panels=r.find(">."+l.panel);l=d.offsetReverse?"right":"left";r=d.carousel3d?"visible":"hidden";b.panels.css(b.conf.setFloat?{"float":l}:{}).add(b.viewport).css({overflow:r}).add(b.container).css({position:"relative",zoom:1});d.vertical||(p=b.panels[0].tagName,r=a("<DIV/>"),p=a("<"+p+"/>"),g={width:0,height:0,clear:"both"},b.container.css("float",l).append(p.css(g)).after(r.css(g)));
b.trigger("loading");a("IMG",f).imagesLoaded().done(function(){b.resReady=!0;b.trigger("ready")});a(window).bind("load",function(){b.trigger("ready")})}}};(function(a,f){a.panel2panel=function(a){if(this.conf.carousel){var e=this.slides.length;if(0>=e)return 0;for(;a>this.smax;)a-=e;for(;a<this.smin;)a+=e}else a>this.smax&&(a=this.smax),a<this.smin&&(a=this.smin);return a};a.slide2panel=function(a){return this.panel2panel(a+this.smin)};a.panel2slide=function(a){return this.panel2panel(a)-this.smin};
...
this.pd[0],a=0;this.offset=[0];for(var c=0;c<b.length;c++)this.offset.push(a+=b[c])}else{var b=this.pd[0],e=this.conf.vertical?1:0;this.offset=[];for(var a=this.panels.eq(0).offset(),f=e?a.top:a.left,f=f-this.pm[e][0][0],c=0;c<b.length;c++)a=this.panels.eq(c).offset(),a=e?a.top:a.left,a=parseFloat(a)-f-this.pm[e][c][0],this.offset.push(a);this.panels.length&&this.offset.push(parseFloat(a)+this.pd[0][c-1])}},99);a.plugin("loading",function(){e.call(this,0);e.call(this,1)},-99);a.plugin("ready",function(){this.updatePanelsDim();
...
(function(a,g){function f(){var a=this.slide2slide(this.position),b=this.conf,d=b.alignPanelDim,c=b.alignViewport,f=b.panelsVisible;if(!b.carousel)if(b.fillViewport){var b=f*c-d,h=-1*b+f-1;a<this.smin+b&&(a=this.smin+b);a>this.smax-h&&(a=this.smax-h)}else b.shrinkViewport&&(a>this.smax+1-this.smin-f?f=this.smax+1-a:a<this.smin-1+f&&(f=this.smin+1+a));a+=d-c*f;d=[];c=a;h=Math.floor(c);a+=f;f=Math.ceil(a);for(b=this.slides.length;b--;)d[b]=0;for(b=h;b<f;b++){var h=c-b,g=a-b,m=this.slide2slide(b);d[m]=
1>g?d[m]+g:d[m]+1;0<h&&(d[m]-=h)}c=this.se;this.se=d;this.trigger("changedExposure",d,c)}function h(){if(!0===this.isReady){isNaN(this.vp_x)&&eval("debugger");isNaN(this.ct_off)&&eval("debugger");var a;a=0;for(var b=[],d=this.smin,c=this.pd[0],f=this.slides.length,h=this.ct_off,g=h+this.vp_x;f--;)b[f]=0;if(this.vp_x)for(f=0;a<g;f++){var m=this.panel2slide(f),k=a+c[m+d];if(k<h||a>g)a=0;else if(a>=h&&k<=g)a=1;else if(a<h&&k>g)a=(g-h)/(k-a);else if(a<h)a=(k-h)/(k-a);else if(k>g)a=(g-a)/(k-a);else throw"updateVisibility has invalid state";
b[m]+=a;a=k}d=this.sv;this.sv=b;this.trigger("changedVisibility",b,d)}}a.plugin("layout",f,-99);a.plugin("loading",f,-99);a.plugin("changedPosition",f,-99);a.plugin("layout",h,99);a.plugin("changedPosition",h,99)})(RTP.Slider.prototype,jQuery);
...
a=this.pd[0][b]*(a-b);a+=this.offset[b];h&&(a+=(this.offset[this.smax+1]-this.offset[this.smin])*e);return a};a.getPositionByOffset=function(a,h){a=parseInt(a+.5,10);var e=this.offset[this.smin],b=this.offset[this.smax+1],d=this.conf.alignPanelDim+this.smin,c=0,l=0;if(this.conf.carousel&&b>e){for(;a<e;)c--,a+=b-e;for(;b<=a;)c++,a-=b-e}else{if(a<=e)return this.smin;if(a>=b)return this.smax+1}for(e=this.panels.length;e--;){var b=this.offset[e+0],g=this.offset[e+1];if(b==a)return e-d;if(g>a&&a>b)return h&&
(l=c*this.slides.length),(a-b)/(g-b)+e-d+l}throw"getPositionByOffset has invalid state";};a.plugin("layout",function(){this.position=this.slide2slide(this.position)},-999);a.plugin("layout",function(){this.setOffsetByPosition(this.position)},999)})(RTP.Slider.prototype,jQuery);
...
(a.locked=!1,b&&(b.call(a),b=null))});return a.locked.prerequisite()}};var h=function(a,e,f,h,g){var k=this;k.queue.push({keep:g,action:a,easing:f||this.conf.easeFunction,duration:null==e||isNaN(e)?this.conf.easeDuration:e,step:function(){d.call(k,this,arguments)},complete:function(){h&&h.call(k,this);b.call(k,this)}})};a.abortAnimation=function(){this.queue.length=0;this.animating&&!0!==this.animating&&this.animating.stop(!0,!1);this.animating=this.locked=!1};var e=function(){if(!this.animating&&
!this.locked&&0!=this.queue.length){var a=this.queue.shift();a.action.toString().match(/^f(\d+)/i)&&(a.action=RegExp.$1,a.fader=this.conf.tiles&&this.conf.fader);var b=f.call(this,a.action);this.resume=function(){this.trigger("startAnimation");this.animating=!0;var b=this.position,d={pos:b},e=f.call(this,a.action);if(e==b)a.complete.call({pos:e});else{if(this.conf.carousel&&!a.keep){var h=Math.abs(b-e),l=e-this.slides.length,q=e+this.slides.length;h>Math.abs(l-b)&&(e=l);h>Math.abs(q-b)&&(e=q)}this.animation=
a;this.animating=g(d).animate({pos:e},a)}a.fader&&(this.trigger("changedPosition",this.position),g(".rtp-slider-fader",this.el).css({opacity:"1",display:"block"}));this.resume=null};b!=this.position&&this.trigger("preAnimation");this.resume&&!this.locked&&this.resume.call(this)}},b=function(a){this.animating=!1;this.setPosition(a.pos);this.animation&&this.animation.fader&&(this.animation.fader=!1,this.trigger("changedPosition"));this.animation={};this.resume=function(){this.trigger("stopAnimation");
e.call(this);this.resume=null};g(".rtp-slider-fader",this.el).css("display","none").css("opacity","");this.setOffsetByPosition(this.position);0==this.queue.length&&this.trigger("postAnimation");this.resume&&!this.locked&&this.resume.call(this)},d=function(a,b){var d=this.animation;d.fader||this.setPosition(a.pos);if(d.fader&&(d=b[1].end,b=b[1].start,d!=b)){a=(a.pos-b)/(d-b);g(".rtp-slider-fader",this.el).show().find(".tile").css("opacity",a);for(var e=[],f=0;f<this.slides.length;f++)e[f]=f==this.slide2slide(d)?
a:f==this.slide2slide(b)?1-a:0;this.se=this.sv=e;this.trigger("foobarVisibility",e)}};a.animate=function(a,b,d,f,m){g.isFunction(a)&&(a=a.call(this));this.trigger("interaction",a);h.apply(this,arguments);e.call(this)};a.goTo=function(a,b,d,f,m){g.isFunction(a)&&(a=a.call(this));h.apply(this,arguments);e.call(this)};a.goNext=function(a,b){this.animate("+1",a,b)};a.goPrev=function(a,b){this.animate("-1",a,b)};a.goFirst=function(a,b){this.animate("0",a,b)};a.goLast=function(a,b){this.animate(this.slen-
1,a,b)}})(RTP.Slider.prototype,jQuery);
...
(function(a,g){function f(){if(!0===this.isReady&&"viewportByPanels"==this.conf.sizerDim){var a=0,e=this.se;0==e.length&&eval("debugger");for(var b=0;b<e.length;b++)0!=e[b]&&(a+=this.pd[0][b+this.smin]*e[b]);this.updateViewportDim(a)}}a.plugin("adjustViewport",f,9999);a.plugin("changedPosition",f,9999)})(RTP.Slider.prototype,jQuery);
...
a)*(b[f]-d)/(c-d)));e=Math.max.apply(Math,e);this.updateViewportOpp(parseInt(a+e-.51))}}a.plugin("config",function(a){a({autoVpOppDeadZone:.2,autoVpOppLifeZone:.8})});a.plugin("adjustViewport",f,9999);a.plugin("changedPosition",f,9999);a.plugin("foobarVisibility",f,9999)})(RTP.Slider.prototype,jQuery);
(function(a,g){function f(a){return a+1+"/"+this.slides.length}function h(a,b){var d=this.klass.panelHidden,e=this.klass.panelPartial,f=this.klass.panelVisible;.999<b?this.navDot.eq(a).addClass(f).removeClass(d).removeClass(e):.001>b?this.navDot.eq(a).addClass(d).removeClass(e).removeClass(f):this.navDot.eq(a).addClass(e).removeClass(d).removeClass(f);d=this.conf.navDotStepFunction;g.isFunction(d)&&d.call(this,a,b)}function e(a){if(this.conf.navDots)if(this.conf.groupPanels)for(var b=this.conf.panelsVisible,
d=0,e=a.length;d<e;d+=b){for(var f=0,g=0,n=0;n<b&&d+n<e;n++)f+=a[d+n],g++;f=Math.pow(f/g,b);for(n=0;n<b&&d+n<e;n++)h.call(this,d,f)}else for(d=0;d<a.length;d++)h.call(this,d,a[d])}function b(a){if(this.navDot){a||(a=this.conf);a=a.panelsVisible;var b=Math.ceil(this.navDot.length/a);this.navDotCountClass&&(this.navDotWrapper.removeClass(this.navDotCountClass),this.navDotCountClass=null);this.conf.navDotCountClass&&(this.navDotCountClass=this.klass.navDotCount+b,this.navDotWrapper.addClass(this.navDotCountClass));
...
navDotCount:"rtp-nav-dot-count-",panelHidden:"rtp-nav-dot-hidden",panelPartial:"rtp-nav-dot-partial",panelVisible:"rtp-nav-dot-visible"},tmpl:{navDotWrapper:['<span><a href="javascript:void(0);">',"</a></span>"],navDotElement:'<img src="img/rtp-nav-dot-clear.gif" width="12" height="12" alt=""/>'},selector:{navDotImage:"IMG"}})});a.plugin("init",function(){var a=this,e=a.tmpl,f=a.conf;if(f.navDots&&1<a.slides.length){a.navDot=g();a.navDotImg=g();a.navDotWrapper=g('<div class="rtp-nav-dots">');a.slides.each(function(b){var k=
g(e.navDotWrapper[0]+e.navDotElement+e.navDotWrapper[1]).addClass(a.klass.navDot).addClass([a.klass.navDot,b].join("-")).click(function(){a.animate(a.conf.fader?"f"+b:"="+b,null,null,null,!0)}).appendTo(a.navDotWrapper),p=g(f.selector.navDotImage,k);d(f.navDotAltFormat)&&p.attr("alt",f.navDotAltFormat.call(a,b));d(f.navDotTitleFormat)&&p.attr("title",f.navDotTitleFormat.call(a,b));a.navDot.push(k.get(0));a.navDotImg.push(p.get(0));h.call(a,b,0)});var p=a.wrapper[f.navDotPosition];p&&p.call(a.wrapper,
...
2][0]>f[e-1][0]&&f[e-1][0]<a&&(f.length=0));20<f.length&&f.shift();f.push([a,d,(new Date).getTime()]);if(!c.swipeDrag)return!0;this.trigger("swipeDraw",c);return!c.swipeDrag});a.plugin("swipeStop",function(a,d,c){this.trigger("abortAnimation");var f=c.swipeMoves;this.trigger("swipeMove",a,d,c,0,0);this.undefer("swipeDraw");for(var g=(new Date).getTime()-500,p=Math.floor(this.conf.panelsVisible);f.length&&f[0][2]<g;)f.shift();g=e(f,this.vp_x/2)[0]*this.vp_x/2;f=Math.abs(g);0==a&&0==d&&(f=0);p=h.call(this,
c.swipeStartPosition,c.swipePosOff,Math.pow(.5*f*p,.5)*-(0>g?-1:1));p=Math.round(this.position+p)-this.position;this.locked=!1;this.trigger("abortAnimation");this.trigger("swipeFinish",a,d,c);a=0;d="linear";g=Math.abs(p);.5<g?(d=.375>f?"easeOutBounce":"easeOutExpo",a=Math.max(Math.min(100/Math.pow(1/f,1.5),9E3),1200)):0<g&&(d=.375>f?"easeOutBounce":"easeOutExpo",a=Math.max(Math.min(100/Math.pow(1/f,1.5),2E3),600));f=c.swipeDrag;delete c.swipeDrag;delete c.swipeScroll;c.swipeMoves=[];this.animate(0>
p?p:"+"+p,a,d,function(){this.swiping=this.foobar=!1},!0);return!f})})(RTP.Slider.prototype,jQuery);
(function(a,g){a.plugin("config",function(a){a({gestureSwipe:!1})});var f=function(a,d){if(!this.conf.gestureSwipe)return!0;d=d.finger;var c=this.conf.vertical;this.trigger("swipeStop",c?d.y:d.x,c?d.x:d.y,a)},h=function(a,d){if(!this.conf.gestureSwipe)return!0;var c=d.finger,e=this.conf.vertical;this.trigger("swipeMove",e?c.y:c.x,e?c.x:c.y,a,e?d.dy:d.dx,e?d.dx:d.dy);a.swipeDrag?(this.conf.carousel?d.stopPropagation():(a.position!==this.position||0!=this.position&&this.position!=this.smax)&&d.stopPropagation(),
a.position=this.position):d.stopPropagation()},e=function(a,d){if(!this.conf.gestureSwipe)return!0;d=d.finger;var c=this.conf.vertical;this.trigger("swipeStart",c?d.y:d.x,c?d.x:d.y,a)};a.plugin("start",function(){var a={};this.viewport.gesture({native:{panY:!this.conf.vertical,panX:!!this.conf.vertical}}).bind("handmove",function(a){}).bind("handstop",g.proxy(f,this,a)).bind("handmove",g.proxy(h,this,a)).bind("handstart",g.proxy(e,this,a)).bind("handstart",function(a){1==a.gesture.fingers&&a.preventDefault()})})})(RTP.Slider.prototype,
jQuery);
...
(function(a,g){a.plugin("config",function(a){a({adjustTabIndex:!0})});a.plugin("ready",function(){if(this.conf.adjustTabIndex){for(var a=this.slides.length;a--;){var h=g(this.slides[a]);h.data("links",g("A",h))}g("A",this.panels).attr("tabindex","-1")}});a.plugin("changedSlideVisibility",function(a,h){this.conf.adjustTabIndex&&(a=g(a).data("links"))&&a.attr("tabindex",h?"":"-1")})})(RTP.Slider.prototype,jQuery);
(function(a,g){a.plugin("config",function(a){a({withinThreshold:.995});this.within=[]});a.plugin("changedVisibility",function(a,g){for(g=a.length;g--;){var e=this.within[g],b=a[g]>this.conf.withinThreshold?1:0;b!=e&&(this.within[g]=b,this.trigger("changedSlideVisibility",this.slides[g],b,e))}})})(RTP.Slider.prototype,jQuery);
...
(function(a,g){function f(a,d){if(this.conf.tiles){a=this.vp_x/this.conf.tileCols;for(var c=this.vp_y/this.conf.tileRows,e=0,f=this.vp_y/this.conf.tileRows,g=this.vp_x/this.conf.tileCols,h=0;h<this.conf.tileRows;h++){for(var k=0,n=0;n<this.conf.tileCols;n++){var q=1/this.conf.tileCols*this.conf.tileColsAtOnce,t=1/this.conf.tileRows*this.conf.tileRowsAtOnce,u=1==this.conf.tileRows?0:(1-t)/(this.conf.tileRows-1)*h,q=(d-(1==this.conf.tileCols?0:(1-q)/(this.conf.tileCols-1)*n))/q,q=Math.max(0,Math.min(1,
q)),t=(d-u)/t,t=Math.max(0,Math.min(1,t)),u=this.conf.tileOppOrigin||0,w=this.conf.tileDimOrigin||0;this.cols[h][n].css({width:a*q+"px",height:c*t+"px",marginTop:u*c*(1-t)+"px",marginLeft:w*a*(1-q)+"px"});this.tiles[h][n].css({opacity:d,marginTop:-1*u*c*(1-t)-e+"px",marginLeft:-1*w*a*(1-q)-k+"px"});k+=g}e+=f}}}function h(){if(this.conf.tiles)for(var a=this.slides.length;a--;){var d=this.slide2panel(a),c=this.pd[0][d],d=this.pd[1][d];g(".rtp-slider-slide-"+a,this.fader).css({width:c+"px",height:d+
"px"})}}a.plugin("config",function(a){a({tiles:!1,tileRows:1,tileCols:1,tileRowsAtOnce:1,tileColsAtOnce:1,tileDimOrigin:.5,tileOppOrigin:.5})});a.plugin("ready",function(b){function d(a){var b=this.conf.offsetReverse;return this.conf.vertical^a?b?"marginBottom":"marginTop":b?"marginRight":"marginLeft"}if(this.conf.tiles){this.rows=[];this.cols=[];this.tiles=[];var c=this.setPosition;this.setPosition=function(a){if(!this.conf.tiles||!this.animation||!this.animation.fader)return c.apply(this,arguments);
if(Math.floor(a)===parseInt(a))return this.animation.fader&&this.animation.restore(),c.call(this,parseInt(a))};var e=this.getContainerOffset,f=this.getContainerOffset=function(a){return this.conf.tiles?"undefined"!=typeof this.ct_off?this.ct_off:-(parseFloat(this.container.css(d.call(this,a)),10)||0):e.apply(this,arguments)};this.setContainerOffset=function(a,b){if(!this.conf.tiles)return f.apply(this,arguments);for(var c=this.offset.length;c--&&!(this.offset[c]<=a););this.container.css(d.call(this,
b),-this.offset[c]);var e=[],g=this.position;if(Math.floor(g)===parseInt(g)&&!this.swiping){for(c=0;c<this.slides.length;c++)e[c]=c==g?1:0;this.sv=e;this.trigger("foobarVisibility",e)}this.ct_off=a};var h=this.getContainerOffset;this.getOffsetByPosition=function(b){return this.conf.tiles?a.getOffsetByPosition.call(this,b):h.apply(this,arguments)};for(b=0;b<this.slides.length;b++)g(this.slides[b]).addClass("rtp-slider-slide-"+b);var m=g('<div class="rtp-slider-fader">');for(b=0;b<this.conf.tileRows;b++){for(var k=
[],n=[],q=g('<div class="row row-'+b+'">'),t=0;t<this.conf.tileCols;t++){var u=g('<div class="col col-'+t+'">'),w=g('<div class="tile tile-'+b+"-"+t+'">');q.append(u);u.append(w);k.push(u);n.push(w)}m.append(q);this.rows.push(q);this.cols.push(k);this.tiles.push(n)}g(this.viewport).append(m);this.fader=m;m.css({top:"0px",left:"0px",right:"0px",bottom:"0px",position:"absolute"})}},-9999);var e=!0;a.plugin("changedPosition",function(a){if(this.conf.tiles){var d=this.position;parseInt(d,10);parseInt(a,
10);var c=Math.floor(d);a=Math.floor(a);if(this.animation&&this.animation.fader){if(this.animation.tiles)return;this.animation.tiles=!0;c=this.animation.action-1;a=this.animation.action-2}if(e||c!=a)for(e=!1,c=Math.min(c),this.slide2panel(c),c=this.slide2panel(c+1),c=this.panels.get(c),c=g(c),this.fader.hide(),a=0;a<this.conf.tileRows;a++)for(var h=0;h<this.conf.tileCols;h++)this.tiles[a][h].empty().append(c.clone().css({margin:"0"}));this.animation.restore=function(){};Math.floor(d)!=d?this.fader.show():
this.fader.hide();f.call(this,d,d-Math.floor(d))}},-999);a.plugin("layout",function(){if(this.conf.tiles)for(var a=0,d=this.conf,c=this.rows,e=this.cols,h=this.tiles,p=this.vp_y/d.tileRows,m=this.vp_x/d.tileCols,k=0;k<d.tileRows;k++){var n=0,q=p+"px";1==d.tileRows&&(q="100%");c[k].css({left:"0px",right:"0px",width:"auto",height:q,top:a+"px",overflow:"hidden",position:"absolute"});for(q=0;q<d.tileCols;q++)e[k][q].css({left:n+"px",height:"auto",top:"0px",bottom:"0px",overflow:"hidden",position:"absolute"}),
h[k][q].css({width:2*this.vp_x,height:2*this.vp_y,marginTop:-a,marginLeft:-n}),g(".rtp-slider-panel",h[k][q]).css({"float":"none",opacity:"1"}),n+=m;a+=p}a=this.position;f.call(this,a,a-Math.floor(a))},0);a.plugin("updatedViewportOpp",function(){if(this.conf.tiles){var a=this.conf.alignPanelOpp,d=this.conf.vertical?"left":"top";if(!isNaN(a))for(var c=this.slides.length;c--;){var e=this.slide2panel(c),e=(this.vp_y-this.pd[1][e])*a;g(".rtp-slider-slide-"+c).css(d,e+"px")}}},99999);a.plugin("updatedPanelsDim",
h,99999);a.plugin("updatedPanelsOpp",h,99999);a.plugin("foobarVisibility",h,9999)})(RTP.Slider.prototype,jQuery);
(function(a,g){a.plugin("config",function(a){a({carousel3d:!1,klass:{carousel3d:"rtp-slider-carousel3d"}})});a.plugin("init",function(){function f(a){b.apply(this,arguments);var c=this.conf.vertical?"X":"Y",f=360/this.slides.length*a,f=f*(this.conf.vertical?1:-1),g=[];g.push("translateZ(-"+e+"px)");this.conf.vertical&&g.push("translateY("+this.vp_x/2+"px)");g.push("rotate"+c+"("+f+"deg)");this.container.css("transform",g.join(" "))}function h(){if(this.conf.carousel3d){var a=this.conf.vertical;a&&
this.container.css("height",0);var b=this.conf,f=b.alignPanelDim,h=b.alignViewport,b=b.panelsVisible,p=Math.PI/this.slides.length,m=Math.max.apply(Math,this.pd[0])/2;e=parseFloat(m/Math.tan(p),10);f=b*(h-.5)-f+.5;this.panels.css({position:"absolute",outline:"1px solid transparent"});this.cloned.hide();for(var h=a?-360:360,p=a?"X":"Y",k=m=this.slides.length;k--;){var n=h/m*k+f,q=[];a&&q.push("translateY(-"+this.vp_x/2+"px)");q.push("rotate"+p+"("+n+"deg)");q.push("translateZ("+e+"px)");g(this.slides[k]).css("transform",
q.join(" "))}this.viewport.css({perspective:e*b/2});this.container.css({width:"100%",overflow:"visible","transform-style":"preserve-3d"})}}if(this.conf.carousel3d){var e,b=this.setOffsetByPosition;this.viewport.addClass(this.klass.carousel3d);this.setOffsetByPosition=f;this.setContainerOffset=function(a){this.ct_off=a};a.plugin("adjustViewport",h,-99)}})})(RTP.Slider.prototype,jQuery);
