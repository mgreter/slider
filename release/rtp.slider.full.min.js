...
(function(a){function g(c,b,d){for(var e=0,k=d.length;e<k;e++)a.isFunction(d[e][c])&&d[e][c].call(d[e],b)}function f(c,b){g("preLayout",c,b);for(var d=0,a=b.length;d<a;d++){var e=b[d].layout.children;e&&e.length&&f(c,e)}g("postLayout",c,b)}function h(c,b){e.initialized=!0;g("updateLayout",c,b);for(var d=0,a=b.length;d<a;d++){var k=b[d].layout.children;k&&k.length&&h(c,k)}}function e(c,k){c={force:c};k=k?a(k):q;n&&(d.css("overflow-y",n),n=null);m&&(d.css("overflow-x",m),m=null);var g=b.innerWidth(),
l=b.innerHeight();f(c,k);var p=b.innerWidth(),t=b.innerHeight();if(g!=p||l!=t){f(c,k);var r=b.innerWidth(),u=b.innerHeight();if(p!=r||t!=u)g=function(){if(B||t!=u)m=d.css("overflow-x"),"hidden"!=m&&d.css("overflow-x","scroll");if(B||p!=r)n=d.css("overflow-y"),"hidden"!=n&&d.css("overflow-y","scroll")},e.initialized&&g(),f(c,k),e.initialized||g()}h(c,k)}for(var b=a(window),d=null,c=60,k,q=a(),l=a(),m,n,p=navigator.userAgent.toLowerCase(),r=/(chrome)[ \/]([\w.]+)/.exec(p)||/(webkit)[ \/]([\w.]+)/.exec(p)||
/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(p)||/(msie) ([\w.]+)/.exec(p)||0>p.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(p)||[],p=r[1]||"",r=r[2]||"0",t="msie"==!p||8!=parseInt(r,10),B="mozilla"==p,x=window.requestAnimationFrame,u=window.cancelAnimationFrame||window.cancelRequestAnimationFrame,y=["ms","moz","webkit","o"],w=0;w<y.length&&!x;++w)x=window[y[w]+"RequestAnimationFrame"],u=window[y[w]+"CancelAnimationFrame"]||window[y[w]+"CancelRequestAnimationFrame"];if(x)var v=function(c){return x(c)};
v||(v=window.setTimeout);u||(u=window.clearTimeout);var D=v,E=u;e.ua={browser:p,version:r};e.config=function(b,d){switch(b){case "fps":c=d;break;case "vsync":t=d;break;case "default":v=D;u=E;break;case "fallback":v=window.setTimeout,u=window.clearTimeout}z=t?function(){e()}:C};e.schedule=function(c,b){if(b||!k)k&&u(k),k=v(function(){e();k=null},c||0)};e.defer=function(b,d){"undefined"==typeof d&&(d=1E3/c);return v(b,d)};e.undefer=function(c){return u(c)};e.add=function(c){d||(d=a("BODY:first"));c.layout=
a.extend({children:[]},c.layout);c.layout&&c.layout.parent?(c.layout.parent.layout.children||(c.layout.parent.layout.children=[]),c.layout.parent.layout.children.push(c)):q=q.add(a(c));a.isFunction(c.startLayout)&&c.startLayout.call(c);c=a(c);0==l.length&&0<c.length&&a(window).bind("resize",z);l=l.add(c)};e.del=function(c){a.isFunction(c.stopLayout)&&c.stopLayout.call(c);c=a(c);l=l.not(c);q=q.not(c);0==l.length&&a(window).unbind("resize",z)};var A=!1,C=function(){if(A)return!1;A=v(function(){e();
A=!1},1E3/c)},z=t?function(){e()}:C;"undefined"==typeof OCBNET&&(window.OCBNET={});OCBNET.Layout=e})(jQuery);if("undefined"==typeof OCBNET)var OCBNET={};var isChromium=window.chrome,vendorName=window.navigator.vendor,decideScrollOrPanOnFirst=null!==isChromium&&"Google Inc."===vendorName;
(function(a){var g={},f=[],h=0,e={};OCBNET.Gestures=function(b,d){this.el=b;this.config=a.extend({native:{},swipeSectors:2,swipeMinDistance:15,decideOnFirst:decideScrollOrPanOnFirst},d,!0);this.id=h++;f.push(this);this.maximum=this.fingers=0;this.finger={};this.ordered=[];this.surface=e;a(b).bind("dragstart",function(){return!1});for(var c=0,k=this.init.length;c<k;c++)this.init[c].apply(this,arguments)};OCBNET.Gestures.fingerup=function(b){for(var d=f.length;d--;)f[d].fingerUp(b);g[b.id]&&(g[b.id].x=
...
Math.atan2(m,c)/Math.PI/90*this.config.swipeSectors,10),this.swipeSector=Math.min(this.swipeSector,this.config.swipeSectors-1));"undefined"!=typeof this.swipeSector&&a(this.el).triggerHandler(new a.Event("handswipe",b));1<this.fingers&&a(this.el).triggerHandler(new a.Event("handtransform",b))}};b.fingerUp=function(b){var c=b.id;if(this.hasFinger(c)){var k=this.getFinger(c);k.x=b.x;k.y=b.y;var f=g[c].x-b.x;b=g[c].y-b.y;this.stop={center:this.getCenter(),rotation:this.getRotation(),distance:this.getDistance()};
this.offset={x:this.stop.center.x-this.start.center.x,y:this.stop.center.y-this.start.center.y};this.center=this.stop.center;this.rotation=this.stop.rotation-this.start.rotation;this.distance=this.stop.distance-this.start.distance;f=new a.Event("handstop",{dx:f,dy:b,finger:k,gesture:this});a(this.el).triggerHandler(f);this.fingers--;delete this.offset;delete this.rotation;delete this.distance;delete this.swipeSector;f.isDefaultPrevented()?(k=a.inArray(k.id,this.ordered),this.ordered.splice(k,1),delete this.finger[c]):
(this.finger={},this.fingers=0,this.ordered.length=0);k=a.inArray(this,e[c]);-1!=k&&e[c].splice(k,1);0==e[c].length&&(delete g[c],delete e[c])}};b.getCenter=function(){var b={x:0,y:0},c;for(c in this.finger){var a=this.finger[c];b.x+=a.x;b.y+=a.y}this.fingers&&(b.x/=this.fingers,b.y/=this.fingers);return b};b.getRotation=function(){if(2>this.fingers)return 0;for(var b=0,c=0,a=0,e=0,f=this.ordered.length;e<f;e++)for(var h=this.finger[this.ordered[e]],g=e+1;g<f;g++){a++;var p=this.finger[this.ordered[g]],
b=b+(p.x-h.x),c=c+(p.y-h.y)}return 180*Math.atan2(c/a,b/a)/Math.PI};b.getDistance=function(){if(2>this.fingers)return 0;for(var b=0,c=0,a=0,e=0,f=this.ordered.length;e<f;e++)for(var h=this.finger[this.ordered[e]],g=e+1;g<f;g++){a++;var p=this.finger[this.ordered[g]],b=b+Math.abs(p.x-h.x),c=c+Math.abs(p.y-h.y)}b/=a;c/=a;return Math.sqrt(b*b+c*c)};b.hasFinger=function(b){return b in this.finger};b.getFinger=function(b){return this.finger[b]}})(OCBNET.Gestures.prototype);a.fn.gesture=function(b){a(this).each(function(d,
...
b.trigger("config",h);a(["text","tmpl","klass","selector"]).each(function(){b[this]=d[this]});var c=b.tmpl,k=b.klass;isNaN(d.align)&&(d.align=.5);isNaN(d.panelsVisible)&&(d.panelsVisible=1);var q=b.container=a(g),l=b.slides=q.find(">."+k.panel);if(!(d.dontInitSingle&&2>l.length)){f=b.viewport=q.wrapAll(c.viewport).parent();c=b.wrapper=f.wrapAll(c.wrapper).parent();g=g.attributes;for(var m=g.length;m--;)f.attr(g[m].name,g[m].value),q.removeAttr(g[m].name);q.css({margin:"0",padding:"0"});c.addClass(k.wrapper);
f.addClass(k.viewport);q.addClass(k.container);b.smin=b.smax=0;d.vertical&&k.vertical&&b.wrapper.addClass(k.vertical);!d.vertical&&k.horizontal&&b.wrapper.addClass(k.horizontal);b.position=a.isFunction(d.slideFirst)?d.slideFirst.call(b):d.slideFirst||0;g=e("align",.5);e("alignPanelDim",g);e("alignPanelOpp",g);e("alignViewport",g);for(g=this.slides.length;g--;)c=a(this.slides[g]),"dim"==d.panelFixedAxis?c.outerWidth(c.width()):"opp"==d.panelFixedAxis&&c.outerHeight(c.height());b.cloned=a();if(d.carousel&&
l.length){g=d.cloneAfter;c=d.cloneBefore;m=d.clonePanels;m=!0===m?Math.ceil(d.panelsVisible):!1===m?0:parseInt(m+.5);g=!0===g?Math.ceil(m*(1-d.alignViewport)):!1===g?0:isNaN(g)?0:g;for(var c=!0===c?Math.ceil(m*(0+d.alignViewport)):!1===c?0:isNaN(c)?0:c,m=a([]),n=a([]);c>l.length;)c-=l.length,a.merge(n,l.clone());for(0<c&&(n=a.merge(l.slice(-c).clone(),n));g>l.length;)g-=l.length,a.merge(m,l.clone());0<g&&a.merge(m,l.slice(0,g).clone());m.appendTo(b.container).addClass("cloned");n.prependTo(b.container).addClass("cloned");
b.smax+=m.length;b.smax+=n.length;b.smin+=n.length;a.merge(b.cloned,n);a.merge(b.cloned,m);b.before=n;b.after=m}b.trigger("init");b.panels=q.find(">."+k.panel);k=d.offsetReverse?"right":"left";q=d.carousel3d?"visible":"hidden";b.panels.css(b.conf.setFloat?{"float":k}:{}).add(b.viewport).css({overflow:q}).add(b.container).css({position:"relative",zoom:1});d.vertical||(l=b.panels[0].tagName,q=a("<DIV/>"),l=a("<"+l+"/>"),g={width:0,height:0,clear:"both"},b.container.css("float",k).append(l.css(g)).after(q.css(g)));
...
1>g?d[m]+g:d[m]+1;0<h&&(d[m]-=h)}c=this.se;this.se=d;this.trigger("changedExposure",d,c)}function h(){if(!0===this.isReady){isNaN(this.vp_x)&&eval("debugger");isNaN(this.ct_off)&&eval("debugger");var a;a=0;for(var b=[],f=this.smin,c=this.pd[0],h=this.slides.length,g=this.ct_off,l=g+this.vp_x;h--;)b[h]=0;if(this.vp_x)for(h=0;a<l;h++){var m=this.panel2slide(h),n=a+c[m+f];if(n<g||a>l)a=0;else if(a>=g&&n<=l)a=1;else if(a<g&&n>l)a=(l-g)/(n-a);else if(a<g)a=(n-g)/(n-a);else if(n>l)a=(l-a)/(n-a);else throw"updateVisibility has invalid state";
b[m]+=a;a=n}f=this.sv;this.sv=b;this.trigger("changedVisibility",b,f)}}a.plugin("layout",f,-99);a.plugin("loading",f,-99);a.plugin("changedPosition",f,-99);a.plugin("layout",h,99);a.plugin("changedPosition",h,99)})(RTP.Slider.prototype,jQuery);
...
a=this.pd[0][b]*(a-b);a+=this.offset[b];h&&(a+=(this.offset[this.smax+1]-this.offset[this.smin])*e);return a};a.getPositionByOffset=function(a,h){a=parseInt(a+.5,10);var e=this.offset[this.smin],b=this.offset[this.smax+1],d=this.conf.alignPanelDim+this.smin,c=0,g=0;if(this.conf.carousel&&b>e){for(;a<e;)c--,a+=b-e;for(;b<=a;)c++,a-=b-e}else{if(a<=e)return this.smin;if(a>=b)return this.smax+1}for(e=this.panels.length;e--;){var b=this.offset[e+0],q=this.offset[e+1];if(b==a)return e-d;if(q>a&&a>b)return h&&
(g=c*this.slides.length),(a-b)/(q-b)+e-d+g}throw"getPositionByOffset has invalid state";};a.plugin("layout",function(){this.position=this.slide2slide(this.position)},-999);a.plugin("layout",function(){this.setOffsetByPosition(this.position)},999)})(RTP.Slider.prototype,jQuery);
...
(a.locked=!1,b&&(b.call(a),b=null))});return a.locked.prerequisite()}};var h=function(a,f,e,h,g){var n=this;n.queue.push({keep:g,action:a,easing:e||this.conf.easeFunction,duration:null==f||isNaN(f)?this.conf.easeDuration:f,step:function(){d.call(n,this,arguments)},complete:function(){h&&h.call(n,this);b.call(n,this)}})};a.abortAnimation=function(){this.queue.length=0;this.animating&&!0!==this.animating&&this.animating.stop(!0,!1);this.animating=this.locked=!1};var e=function(){if(!this.animating&&
!this.locked&&0!=this.queue.length){var a=this.queue.shift();a.action.toString().match(/^f(\d+)/i)&&(a.action=RegExp.$1,a.fader=this.conf.tiles&&this.conf.fader);var b=f.call(this,a.action);this.resume=function(){this.trigger("startAnimation");this.animating=!0;var b=this.position,d={pos:b},e=f.call(this,a.action);if(e==b)a.complete.call({pos:e});else{if(this.conf.carousel&&!a.keep){var h=Math.abs(b-e),k=e-this.slides.length,r=e+this.slides.length;h>Math.abs(k-b)&&(e=k);h>Math.abs(r-b)&&(e=r)}this.animation=
...
d=0,e=a.length;d<e;d+=b){for(var f=0,g=0,p=0;p<b&&d+p<e;p++)f+=a[d+p],g++;f=Math.pow(f/g,b);for(p=0;p<b&&d+p<e;p++)h.call(this,d,f)}else for(d=0;d<a.length;d++)h.call(this,d,a[d])}function b(a){if(this.navDot){a||(a=this.conf);a=a.panelsVisible;var b=Math.ceil(this.navDot.length/a);this.navDotCountClass&&(this.navDotWrapper.removeClass(this.navDotCountClass),this.navDotCountClass=null);this.conf.navDotCountClass&&(this.navDotCountClass=this.klass.navDotCount+b,this.navDotWrapper.addClass(this.navDotCountClass));
...
g(e.navDotWrapper[0]+e.navDotElement+e.navDotWrapper[1]).addClass(a.klass.navDot).addClass([a.klass.navDot,b].join("-")).click(function(){a.animate(a.conf.fader?"f"+b:"="+b,null,null,null,!0)}).appendTo(a.navDotWrapper),p=g(f.selector.navDotImage,l);d(f.navDotAltFormat)&&p.attr("alt",f.navDotAltFormat.call(a,b));d(f.navDotTitleFormat)&&p.attr("title",f.navDotTitleFormat.call(a,b));a.navDot.push(l.get(0));a.navDotImg.push(p.get(0));h.call(a,b,0)});var l=a.wrapper[f.navDotPosition];l&&l.call(a.wrapper,
...
case "toggle-stop":h.stop.call(this)?this.startAutoSlide():this.stopAutoSlide(!1)}}this.buttons={};if(this.conf.navToolbar&&this.conf.navToolbarButtons){for(var b=this.conf.navToolbarButtons.split(/\s*,\s*/),d=g('<div class="rtp-toolbar">'),c=0,f=b.length;c<f;c++){var q=g('<span class="rtp-toolbar-'+b[c]+'">'+this.tmpl.navButtonWrapper[0]+this.tmpl.navButton.replace(/{title}/g,b[c]).replace(/{type}/g,b[c].replace("toggle-",""))+this.tmpl.navButtonWrapper[1]+"</span>").click(g.proxy(a,this,b[c]));
d.append(this.buttons[b[c]]=q);q.imgs=q.find("IMG")}this.toolbarWrapper=d;this.toolbarWrapper.appendTo(this.wrapper)}});a.plugin("ready",f);a.plugin("autoslideStop",f);a.plugin("autoslideStart",f);a.plugin("autoslidePause",f)})(RTP.Slider.prototype,jQuery);
